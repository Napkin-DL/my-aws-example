...
class GENTRL(nn.Module):
    ...
    def get_elbo(self, x, y):
        ...
        zy = torch.cat([latvar_samples, y.cuda(non_blocking=True)], dim=1)
    ...
    def train_as_vaelp(self, train_loader, is_distributed, rank, size, backend, num_epochs=10,
        ...
        while epoch_i < num_epochs:
            ...
            for x_batch, y_batch in train_loader:
                ...
                y_batch = y_batch.float().to(self.lp.tt_cores[0].to(device))
